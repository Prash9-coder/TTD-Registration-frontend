                                    ...
                                    <div className="flex gap-6 items-start">
                                        ...
                                        <div className="flex-shrink-0">
                                            {member.photoPreview ? (
                                                ...
                                                <div className="w-32 h-40 rounded-lg bg-gradient-to-br from-gray-300 to-gray-400 flex items-center justify-center text-white font-bold text-4xl border-4 border-white shadow-lg">
                                                    {(member.name || '')[0] || '?'}
                                                </div>
                                            )}
                                        </div>
